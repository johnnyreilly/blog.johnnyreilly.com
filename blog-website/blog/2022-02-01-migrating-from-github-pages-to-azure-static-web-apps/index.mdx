...
export const faqs = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Why should I migrate from GitHub Pages to Azure Static Web Apps?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "If you like the idea of using a single platform for hosting your static website and deploying previews, then Azure Static Web Apps is a great option. It's also free to use!",
      },
    },
    {
      '@type': 'Question',
      name: 'What is Bicep and how can it be used for migration?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Bicep is a Domain Specific Language (DSL) for deploying Azure resources. It's a great way to define your infrastructure as code. You can use Bicep to deploy your Azure Static Web App. You can also deploy an Azure Static Web App using the Azure Portal or the Azure CLI.",
      },
    },
    {
      '@type': 'Question',
      name: 'How do I enable staging environments / deployment previews in Azure Static Web Apps?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "You don't need to do anything special to enable staging environments. They're enabled by default.",
      },
    },
  ],
};
