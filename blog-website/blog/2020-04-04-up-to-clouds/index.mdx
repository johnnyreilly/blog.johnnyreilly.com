...
We also made some changes so our app would support cookies auth alongside Azure AD auth; [I've written about this previously](../2020-03-22-dual-boot-authentication-with-aspnetcore/index.mdx).
