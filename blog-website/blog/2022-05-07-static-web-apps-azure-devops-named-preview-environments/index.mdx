...
[I'd previously written about how to hand roll preview environments with Azure DevOps using Bicep](../2021-12-05-azure-static-web-app-deploy-previews-with-azure-devops/index.mdx). But now there's dedicated functionality that covers this, let's see if we can test it out.
