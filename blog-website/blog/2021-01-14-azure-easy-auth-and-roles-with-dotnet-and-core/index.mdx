...
_If this post is interesting to you, you may also want to [look at this one where we try to use Microsoft.Identity.Web for the same purpose.](../2021-01-17-azure-easy-auth-and-roles-with-net-and-microsoft-identity-web/index.mdx)_
...
2. It uses [C#s nullable reference types](../2020-12-20-nullable-reference-types-csharp-strictnullchecks/index.mdx)
