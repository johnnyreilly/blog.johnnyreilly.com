...
>
> <div>
>   Type: <a href="http://api.jquery.com/Types/#String">String</a> or{' '}
>   <a href="http://api.jquery.com/Types/#Array">Array</a>
> </div>
>
> <div>
...
>
> <div>
>   A function returning the value to set. <code>this</code> is the current
>   element. Receives the index position of the element in the set and the old
>   value as arguments.
> </div>
