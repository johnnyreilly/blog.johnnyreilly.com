...
[I wrote recently about using C# 9 with in-process Azure Functions.](../2021-07-01-c-sharp-9-azure-functions-in-process/index.mdx) What that amounted to, was using C# 9 with .NET Core.
