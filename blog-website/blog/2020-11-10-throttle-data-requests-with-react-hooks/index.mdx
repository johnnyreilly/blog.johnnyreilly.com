...
Because we're going to be making a number of asynchronous calls, we're going to simplify the code by leaning on the widely used [`react-use`](https://github.com/streamich/react-use) for a [`useAsync`](https://github.com/streamich/react-use/blob/master/docs/useAsync/index.mdx) hook.
...
<head>
  <link
    rel="canonical"
    href="https://blog.logrocket.com/throttling-data-requests-with-react-hooks/"
  />
</head>
